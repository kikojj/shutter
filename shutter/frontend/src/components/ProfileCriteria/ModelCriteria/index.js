...
export default function (props) {
  ...
  return (
    <>
      ...
      />
      <Typography className={classes.fieldMargin} gutterBottom>
        Рост: {props.searchState.height}
      </Typography>
      <Slider
        value={props.searchState.height}
        onChange={(e, v) => props.setSearchState({ ...props.searchState, height: v })}
        valueLabelDisplay="auto"
        aria-labelledby="range-slider"
        min={0}
        max={250}
      ...
      />
      <Typography className={classes.fieldMargin} gutterBottom>
        Вес: {props.searchState.weight}
      </Typography>
      <Slider
        value={props.searchState.weight}
        onChange={(e, v) => props.setSearchState({ ...props.searchState, weight: v })}
        valueLabelDisplay="auto"
        aria-labelledby="range-slider"
        min={0}
        max={200}
